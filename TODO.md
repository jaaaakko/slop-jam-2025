[x] Fix player aim rotation
[x] Figure out why no enemy spawns
[x] Add graphics to player character 
[x] Bug: player ammo does not hit enemies
[x] Upon reaching 0 health, game continues on
